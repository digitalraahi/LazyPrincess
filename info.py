...
PICS = (environ.get('PICS', 'https://te.legra.ph/file/abf4b8ad40daac1bd8358.jpg, https://te.legra.ph/file/abf4b8ad40daac1bd8358.jpg')).split()
...
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','movieflix_admin') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','movieflix_admin')  # WITHOUT @ [  add only handle - don't add full url  ] 
...
# Born to make history @MovieFlix !
# Thank you MovieFlix for helping us in this Journey
# 🥰  Thank you for giving me credit @MovieFlixr  🥰
# for any error please contact me -> telegram@MovieFlixr or insta @MovieFlixr 
# rip paid developers 🤣 - >> No need to buy paid source code while @MovieFlixr is here 😍😍
